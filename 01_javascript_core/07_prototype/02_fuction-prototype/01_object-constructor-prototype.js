...
let student = new Student('홍길동'); //student의 프로토타입은 user이다.
let student2 = new Student('유관순');//student2.__proto__ = user;
let student3 = new Student('신사임당');//student3.__proto__ = user;
console.log(student.name);//본인 프로퍼티
console.log(student.active);//상속 프로퍼티
